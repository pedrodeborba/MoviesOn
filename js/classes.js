...
class Filme
{
    ...
    getDetalhesFilme = () =>{ 
        ...
        btnSalvar.setAttribute('style','width: 100px; height: 30px; margin-right: 10px; margin-top: 20px; background-image: linear-gradient(to right bottom, #ff0000, #ff1334, #ff2c55, #ff4472, #ff598c);border-radius: 20px; color: #fff;');
        ...
        btnDesfavoritar.setAttribute('style','width: 100px; height: 30px; margin-top: 20px; margin-left: 10px; background-image: linear-gradient(to right bottom, #ff0000, #ff1334, #ff2c55, #ff4472, #ff598c);border-radius: 20px;color: #fff;');
        divDetalhes.appendChild(btnDesfavoritar);

        let btnFechar = document.createElement('button');
        btnFechar.appendChild(document.createTextNode('Fechar'));
        btnFechar.setAttribute('id','btnFechar');
        btnFechar.setAttribute('style','width: 70px; height: 30px; margin-top: 20px; margin-left: 20px; background-image: linear-gradient(to right bottom, #ff0000, #ff1334, #ff2c55, #ff4472, #ff598c);border-radius: 20px;color: #fff;');
        ...
        btnEditar.setAttribute('style','width: 70px; height: 30px; margin-left: 20px; margin-top: 20px; background-image: linear-gradient(to right bottom, #ff0000, #ff1334, #ff2c55, #ff4472, #ff598c);border-radius: 20px;color: #fff;');
        ...
        btnEditar.addEventListener('click', () => {
            ...
            saveButton.setAttribute('style','width: 100%; height: 30px; margin-top: 10px; background-image: linear-gradient(to right bottom, #ff0000, #ff1334, #ff2c55, #ff4472, #ff598c);border-radius: 20px;'); 
